...
public class MathUtil {
	 ...
	 * @return
	 */
	public static float addF(float a , float b , int scale){
		BigDecimal b1 = new BigDecimal(a);
		BigDecimal b2 = new BigDecimal(b);
	 ...
	 * @return  a new BigDecimal whose value is this / divisor.
	 */
	public static float divideF(float a , float divisor){
		if (0 == divisor) {
			return 0;
		}
		BigDecimal b1 = new BigDecimal(a);
	 ...
	 * @return 公里单位值
	 */
	public static float meter2KmInt(int meter){
	...
	public static float multiplyF(float a , float b , int newScale){
		BigDecimal b1 = new BigDecimal(a);
		BigDecimal b2 = new BigDecimal(b);
		return b1.multiply(b2).setScale(newScale, BigDecimal.ROUND_HALF_UP).floatValue();
	}
